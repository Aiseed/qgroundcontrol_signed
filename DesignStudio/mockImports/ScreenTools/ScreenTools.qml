...
Item {
    ...
    property real defaultFontDescent:       undefined // FIXME: NYI
    ...
    property bool isShortScreen:                    ((Screen.height / realPixelDensity) < 120) || (isMobile && ((Screen.height / Screen.width) < 0.6))
    property bool isHugeScreen:                     (Screen.width / realPixelDensity) >= (23.5 * 25.4) // 27" monitor
    property bool isSerialAvailable:                false
    ...
    readonly property string normalFontFamily:      "Open Sans"
    readonly property string demiboldFontFamily:    "Open Sans Semibold"
    readonly property string fixedFontFamily:       "Open Sans Semibold" // FIXME: Use a fixed font
    ...
    Text {
        ...
        Component.onCompleted: {
            ...
            if(_screenTools.isMobile) {
                //-- Check iOS really tiny screens (iPhone 4s/5/5s)
                if(_screenTools.isiOS) {
                    if(_screenTools.isiOS && Screen.width < 570) {
